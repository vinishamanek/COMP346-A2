...
public class Network extends Thread {
    ...
    private static Semaphore emptyInBuffer;
    private static Semaphore emptyOutBuffer;
    private static Semaphore fullInBuffer;
    private static Semaphore fullOutBuffer;
    private static Semaphore mutexIn;
    private static Semaphore mutexOut;
   
//    private static Semaphore mutexSemaphore;
     ...
     */
     Network( )
      { 
         ...
         emptyInBuffer = new Semaphore(maxNbPackets); // used to signal an empty buffer, counting semaphore
         emptyOutBuffer = new Semaphore(maxNbPackets); // used to signal an empty buffer, counting semaphore, initialized to 10
         fullInBuffer = new Semaphore(0); // used to signal a full buffer
         fullOutBuffer = new Semaphore(0); // used to signal a full buffer process cannot access CS
         mutexIn = new Semaphore(1); // process can access CS used for mutual exclusion, used for input buffer
         mutexOut = new Semaphore(1); // process can access CS used for mutual exclusion, used for output buffer
...
//         outSemaphore = new Semaphore(0);
     ...
     * @param
     */
     public static synchronized String getInBufferStatus()
     {
         return inBufferStatus;
     }
